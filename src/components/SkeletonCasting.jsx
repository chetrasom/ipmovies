...
const SkeletonCasting = () => {
    return (
        <div role="status" 
        className="relative h-[200px] rounded-md border border-gray-200 shadow animate-pulse dark:border-gray-700 mb-10 w-full">
...
export default SkeletonCasting